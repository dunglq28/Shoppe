<%-- 
    Document   : MainPage
    Created on : Aug 18, 2023, 11:19:57 AM
    Author     : hj
--%>
...
<html>
    ...
    <head>
        ...
        <jsp:useBean id="dao" class="shoppe.Products.ProductsDAO"></jsp:useBean>
        </head>
        ...
        <body>
                        ...
                        <nav class="header__navbar">
                            <ul class="header__navbar-list">
                                ...
                                <li class="header__navbar-item">
                                    <span class="header__navbar-item-title--no-poiner">Kết nối</span>
                            ...
                            <ul class="header__navbar-list">
                                        ...
                                        <ul class="header__notify-list">
                                            <li class="header__notify-item">
                                                <a href="" class="header__notify-link">
                                                    <img src="https://cf.shopee.vn/file/vn-50009109-e827243bf4882d227a69551b4e93f58b_xhdpi"
                                ...
                                <li class="header__navbar-item header__navbar-user">
                                    <img src="https://down-vn.img.susercontent.com/file/43a45f4d49cd567c9559fec31bc55b90_tn" alt="" class="header__navbar-user-img">
                                    <span class="header__navbar-user-name">Quang Dũng</span>
                        ...
                        <div class="header-with-search">
                            ...
                            <div class="header__search">
                                <div class="header__search-input-wrap">
                                    <input type="text" class="header__search-input" placeholder="Tìm trong shop">
                                    <!-- Search history -->
                            ...
                            <div class="header__cart">
                                <div class="header__cart-wrap">
                                    ...
                                    <div class="header__cart-list">
                                        <img class="header__cart-list--no-cart-img" src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/9bdd8040b334d31946f49e36beaf32db.png" alt="">
                                        ...
                                        <ul class="header__cart-list-item">
                                            ...
                                            <li class="header__cart-item">
                                                <img src="https://down-vn.img.susercontent.com/file/2282b130e18f04128db0f1ca0d02b52e_tn" alt="" class="header__cart-img">
                                                <div class="header__cart-item-info">
                                                    <div class="header__cart-item-head">
                                                        <h5 class="header__cart-item-name">Áo Thun Levents Popular Logo Tee/ Dark Teal</h5>
                                                        <div class="header__cart-item-price-wrap">
                                                            <span class="header__cart-item-price">370.000đ</span>
                                        ...
                                        <a class="header__cart-view-cart btn btn--primary">Thanh Toán</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <nav class="category">
                                    ...
                                    <ul class="category-list">
                                        ...
                                        <li class="category-item">
                                            <a href="#" class="category-item__link">Polo</a>
                                        </li>
                                        <li class="category-item">
                                            <a href="#" class="category-item__link">Jacket</a>
                                        </li>
                                        <li class="category-item">
                                            <a href="#" class="category-item__link">Pants</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                            <div class="grid__column-10">
                                <div class="home-filter">
                                    ...
                                    <div class="home-filter__page">
                                        ...
                                        <div class="home-filter__page-control">
                                            <a href="" class="home-filter__page-btn home-filter__page-btn--disalbe">
                                ...
                                <div class="home-product">
                                    ...
                                    <c:if test="${not empty products}">
                                        <c:forEach items="${products}" var="dto" varStatus="counter">
                                            <!-- Product item -->
                                            <div class="grid__column-2-4">
                                                <a href="" class="home-product-item">
                                                    <div class="home-product-item__img" style="background-image: url(${dto.image});"></div>
                                                    <h4 class="home-product-item__name">${dto.productName}</h4>
                                                    <div class="home-product-item__price">
                                                        <c:if test="${dto.discount == 0}">
                                                            <span class="home-product-item__price-current">đ${dto.price} </span>
                                                        </c:if>
                                                        <c:if test="${dto.discount != 0}">
                                                            <span class="home-product-item__price-old">đ${dto.price}</span>
                                                            <span class="home-product-item__price-current">đ${dto.getPriceDiscount()}</span>
                                                        </c:if>
                                                    </div>
                                                    ...
                                                    <c:if test="${dto.discount != 0}">
                                                        <div class="home-product-item__sale-off">
                                                            <span class="home-product-item__sale-off-percent">${dto.discount}%</span>
                            ...
                            <ul class="pagination pagination--mg">
                                <c:if test="${indexCurrent > 1}">
                                    <li class="pagination-item">
                                        <a href="paging?index=${indexCurrent-1}" class="pagination-item__link ">
                                            <i class="pagination-item__icon fas fa-angle-left"></i>
                                        </a>
                                    </li>
                                </c:if>

                                <c:forEach begin="1" end="${dao.numberPage}" var="i">
                                    <li class="pagination-item pagination-item ${indexCurrent==i ? "pagination-item--active" : ""}">
                                        <a href="paging?index=${i}" class="pagination-item__link">${i}</a>
                                    </li>
                                </c:forEach>
            ...
            <footer class="footer">
                <div class="grid">
                    <div class="grid__row">
                        <div class="grid__column-2-4">
                            <h3 class="footer__heading">Chăm sóc khánh hàng</h3>
                            <ul class="footer-list">
                                ...
                                <li class="footer-item">   
                                    <a href="" class="footer-item__link">Shoppe Mail</a>
                                </li>
                                <li class="footer-item">   
                            ...
                            <ul class="footer-list">
                                ...
                                <li class="footer-item">    
                                    <a href="" class="footer-item__link">
                                        ...
                                        <span class="footer-item__text">Linkedln</span>                                  
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <div class="grid__column-2-4">
                            ...
                            <div class="footer__download">
                                ...
                                <div class="footer__download-apps">
                                    ...
                                    <a href="footer__download-app-link">
                                        <img src="assets/img/ggPlay.png" alt="" class="footer__download-app-img">
                                    </a>
                                </div>
                            </div>                   
                        </div>
                ...
                <div class="footer__bottom">
                    <div class="grid">
                        <p class="footer__text">© 2023 - Bản quyền thuộc về Công ty TNHH DNG</p>
                    </div>
                </div>
            </footer>
        </div>
